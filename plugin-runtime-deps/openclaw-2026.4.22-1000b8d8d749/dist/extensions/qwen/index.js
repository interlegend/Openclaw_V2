...
import { A as isQwenCodingPlanBaseUrl, h as QWEN_DEFAULT_MODEL_REF, u as QWEN_36_PLUS_MODEL_ID, x as applyQwenNativeStreamingUsageCompat } from "../../models-DBWl8JzO.js";
import { n as buildQwenProvider } from "../../provider-catalog-ZHLSq2hl.js";
import "../../api-DyO57vRi.js";
import { t as buildQwenMediaUnderstandingProvider } from "../../media-understanding-provider-MRCyCBo9.js";
import { l as applyQwenConfig, m as applyQwenStandardConfigCn, p as applyQwenStandardConfig, u as applyQwenConfigCn } from "../../onboard-B1pTBRQN.js";
import { t as buildQwenVideoGenerationProvider } from "../../video-generation-provider-B6h8PANN.js";
...
var qwen_default = defineSingleProviderPluginEntry({
	...
	provider: {
		...
		suppressBuiltInModel: (ctx) => {
			...
			if (provider !== PROVIDER_ID && provider !== LEGACY_PROVIDER_ID || ctx.modelId !== "qwen3.6-plus" || !isQwen36PlusUnsupportedForConfig({
				config: ctx.config,
				baseUrl: ctx.baseUrl
			})) return;
			return {
